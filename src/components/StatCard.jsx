    ...
    <div className="relative bg-card rounded-xl sm:rounded-2xl border border-border p-3 sm:p-5 max-lg:landscape:p-2.5 shadow-sm hover:shadow-lg transition-all duration-300 group overflow-hidden card-hover">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="text-xl sm:text-3xl max-lg:landscape:text-lg font-extrabold mt-0.5 sm:mt-1.5 text-primary tabular-nums">{displayValue}</p>
        </div>
        <div className={`w-9 h-9 sm:w-12 sm:h-12 max-lg:landscape:w-8 max-lg:landscape:h-8 rounded-lg sm:rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center shadow-md group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shrink-0`}>
